...
public class DriveAvoidPid extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        robot.RL.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        robot.RR.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        ...
        while (opModeIsActive())
        {
            ...
            // set power levels.
            robot.RL.setPower(power - correction);
            robot.FL.setPower(-power + correction);
            robot.FR.setPower(power - correction);
            robot.RR.setPower(-power + correction);
